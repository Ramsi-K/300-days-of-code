...
### [Luna-Net3D: Voxel Recalculation and NPY Conversion](https://github.com/Ramsi-K/3D-Vision-Playground/tree/main/Luna-Net3D)

**<p align="right">2024-05-18</p>**

- **Task Description**:  
Recalculated voxel data after resizing transformations, and converted images to NPY format for faster loading. Organized train/val/test folders with newly processed data.
